...
describe('<VerticalSectionOverflow/>', function () {
    ...
    it('should change the isExpanded state when the button element is clicked and the expanded is set to true', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { expanded: true }));
        expect(component.state().isExpanded).toBe(true);
        component.find('button').simulate('click');
        expect(component.state().isExpanded).toBe(false);
    });
    ...
    it('should pass the right props to Description component when the respective props are passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { description: 'collapsed label', expanded: true }));
        expect(component.find('Description').props()).toEqual({
    ...
    it('should set the assistiveText passed as text in AssistiveText component', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { assistiveText: 'description text' }));
        expect(component.find('AssistiveText').prop('text')).toBe('description text');
    });
    it('should set the right className in the container element when is expanded', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { expanded: true }));
    ...
    it('should set the right className in the container element when is not expanded', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, null));
    ...
    it('should set the right className in the overflow container when is closed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, null));
        expect(component.find('div[data-id="vertical-overflow"]').prop('className')).toBe('rainbow-vertical-section-overflow--hide');
    });
    it('should set the right className in the overflow container when expanded is passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { expanded: true }));
        expect(component.find('div[data-id="vertical-overflow"]').prop('className')).toBe('rainbow-vertical-section-overflow--show');
    });
    it('should set the right className in the overflow container when the button is clicked', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, null));
        expect(component.find('div[data-id="vertical-overflow"]').prop('className')).toBe('rainbow-vertical-section-overflow--hide');
        component.find('button').simulate('click');
        expect(component.find('div[data-id="vertical-overflow"]').prop('className')).toBe('rainbow-vertical-section-overflow--show');
