...
var _isOptionVisible = require('../isOptionVisible');

var _isOptionVisible2 = _interopRequireDefault(_isOptionVisible);
...
describe('isOptionVisible', function () {
    it('should return true when rect dimensions match in element and container', function () {
        ...
        expect((0, _isOptionVisible2.default)(element, container)).toBe(true);
    });
    ...
    it('should return false when element top is less than container top', function () {
        ...
        expect((0, _isOptionVisible2.default)(element, container)).toBe(false);
    });
