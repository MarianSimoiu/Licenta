...
describe('<Spinner/>', function () {
    it('should not render the spinner when isVisible is false', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { isVisible: false }));
        expect(component.children().length).toBe(0);
    });
    it('should not render the spinner when isVisible is true', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { isVisible: true }));
    ...
    it('should have the right class names when a custom class name is passed, variant is brand and size is large', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { variant: 'brand', size: 'large', className: 'custom-container-classname' }));
    ...
    it('should have the right class names when variant is inverse and size is medium', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { variant: 'inverse', size: 'medium' }));
    ...
    it('should have the right class names when variant is neutral and size is medium', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { variant: 'neutral', size: 'medium' }));
    ...
    it('should have the right class names when size is small', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { size: 'small' }));
    ...
    it('should have the right class names when size is x-small', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { size: 'x-small' }));
