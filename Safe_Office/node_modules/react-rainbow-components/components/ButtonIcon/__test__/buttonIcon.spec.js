...
describe('<ButtonIcon/>', function () {
    ...
    it('should set the tabIndex passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { tabIndex: 0 }));

        expect(component.find('button').prop('tabIndex')).toBe(0);
    });
    it('should set the title passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { title: 'my title' }));

        expect(component.find('button').prop('title')).toBe('my title');
    });
    it('should set the type passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { type: 'reset' }));

        expect(component.find('button').prop('type')).toBe('reset');
    });
    it('should set aria-haspopup to true when it is passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { ariaHaspopup: true }));

        expect(component.find('button').prop('aria-haspopup')).toBe(true);
    });
    it('should set aria-controls to true when it is passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { ariaControls: 'testing ariaControls' }));
    ...
    it('should set aria-expanded to true when it is passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { ariaExpanded: true }));
    ...
    it('should pass assistiveText to the prop text of AssistiveText component', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { assistiveText: 'for screen readers' }));
    ...
    it('should have the right class names when variant is border-filled and have a custom class', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { variant: 'border-filled', className: 'my-custom-class-name' }));
    ...
    it('should have the right class names when variant is border-inverse and size is small', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { variant: 'border-inverse', size: 'small' }));
    ...
    it('should have the right class names when variant is border and size is x-small', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { variant: 'border', size: 'x-small' }));
    ...
    it('should have the right class names when variant is brand and size is xx-small', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { variant: 'brand', size: 'xx-small' }));
    ...
    it('should have the right class names when variant is inverse and size is large', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { variant: 'inverse', size: 'large' }));
    ...
    it('should have the right class names when variant is base and size is xx-small', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { size: 'xx-small' }));
    ...
    it('should have the right class names when shaded is passed and variant is brand', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { variant: 'brand', shaded: true }));
