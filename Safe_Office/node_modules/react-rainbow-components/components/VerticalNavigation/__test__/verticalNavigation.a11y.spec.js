...
describe('<VerticalNavigation/>', function () {
    it('should be accessible when use VerticalSection', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var html, results;
                    ...
                    case 0:
                        ...
                        html = _server2.default.renderToString(_react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                { label: 'Section Label' },
                                _react2.default.createElement(_VerticalItem2.default, { name: 'item-1', label: 'Recent' }),
                                _react2.default.createElement(_VerticalItem2.default, { name: 'item-2', label: 'Projects' })
                            )
                        ));
                        _context.next = 4;
    ...
    it('should be accessible when use VerticalSectionOverflow', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var html, results;
