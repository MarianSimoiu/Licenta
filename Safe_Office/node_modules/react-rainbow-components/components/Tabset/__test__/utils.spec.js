...
describe('<Tabset/> utils', function () {
    describe('insertChildOrderly', function () {
        it('should insert the child in the right order if the item in the nodes is at middle', function () {
            var childrenRefs = [{ ref: 'item1' }, { ref: 'item2' }, { ref: 'item4' }, { ref: 'item5' }];
            var nodes = ['item1', 'item2', 'item3', 'item4', 'item5'];
            var expectedNodes = [{ ref: 'item1' }, { ref: 'item2' }, { ref: 'item3' }, { ref: 'item4' }, { ref: 'item5' }];
            expect((0, _utils.insertChildOrderly)(childrenRefs, { ref: 'item3' }, nodes)).toEqual(expectedNodes);
        });
        it('should insert the child in the right order if the item in the nodes is at end', function () {
            var childrenRefs = [{ ref: 'item1' }, { ref: 'item2' }, { ref: 'item3' }];
            var nodes = ['item1', 'item2', 'item3', 'item4'];
            var expectedNodes = [{ ref: 'item1' }, { ref: 'item2' }, { ref: 'item3' }, { ref: 'item4' }];
            expect((0, _utils.insertChildOrderly)(childrenRefs, { ref: 'item4' }, nodes)).toEqual(expectedNodes);
        });
    });
    describe('getChildTabNodes', function () {
        var elements = [{ element: 'a', innerText: 'Julio' }, { element: 'a', innerText: 'Pepe' }];
        var ref = {
            querySelectorAll: jest.fn(function () {
                return elements;
            })
        };
        it('should call querySelectorAll with a[role="tab"]', function () {
    ...
    describe('getTabIndexFromName', function () {
        it('should return the right index', function () {
            var tabChildren = [{ name: 'tab-1' }, { name: 'tab-2' }, { name: 'tab-3' }, { name: 'tab-4' }, { name: 'tab-5' }];
    ...
    describe('getChildrenTotalWidth', function () {
        it('should return 0 when any children in tabset has width', function () {
            var tabsetChildren = [{ name: 'pizza', ref: { offsetWidth: 0 } }, { name: 'onion', ref: { offsetWidth: 0 } }, { name: 'tomato', ref: { offsetWidth: 0 } }];
        ...
        it('should return the right total children width in tabset', function () {
            var tabsetChildren = [{ name: 'pizza', ref: { offsetWidth: 1 } }, { name: 'onion', ref: { offsetWidth: 2 } }, { name: 'tomato', ref: { offsetWidth: 3 } }];
    ...
    describe('isNotSameChildren', function () {
        it('should return true when a children in the tabset was changed in the same position', function () {
            var tabsetChildren = [{ props: { name: 'pizza' } }, { props: { name: 'onion' } }, { props: { name: 'tomato' } }];
            var prevTabsetChildren = [{ props: { name: 'pizza' } }, { props: { name: 'onion' } }, { props: { name: 'mushroom' } }];
        ...
        it('should return false when any children in tabset was changed in the same position', function () {
            var tabsetChildren = [{ props: { name: 'tomato' } }, { props: { name: 'pizza' } }, { props: { name: 'apple' } }];
            var prevTabsetChildren = [{ props: { name: 'tomato' } }, { props: { name: 'pizza' } }, { props: { name: 'apple' } }];
    ...
    describe('getUpdatedTabsetChildren', function () {
        it('should return an updated tabset with the changed tab when a name to update exist in the tabset children', function () {
            var tab = { name: 'mushroom', ref: {} };
            var nameToUpdate = 'tomato';
            var tabsetChildren = [{ name: 'pizza', ref: {} }, { name: 'onion', ref: {} }, { name: 'tomato', ref: {} }];
            var newTabsetChildren = [{ name: 'pizza', ref: {} }, { name: 'onion', ref: {} }, { name: 'mushroom', ref: {} }];
