...
describe('<Tabset />', function () {
    ...
    it('should have the right class names when fullWidth prop is passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(
            _index2.default,
            { fullWidth: true },
            _react2.default.createElement(_Tab2.default, { label: 'Tab-1', name: 'tab-1', registerTab: registerTabMockFn })
        ));
    ...
    it('should set the rainbow-tab--active class only to the third Tab when activeTabName is tab-3', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(
            _index2.default,
            { activeTabName: 'tab-3' },
            _react2.default.createElement(_Tab2.default, { label: 'Tab-1', name: 'tab-1', registerTab: registerTabMockFn }),
            _react2.default.createElement(_Tab2.default, { label: 'Tab-2', name: 'tab-2', registerTab: registerTabMockFn }),
            _react2.default.createElement(_Tab2.default, { label: 'Tab-3', name: 'tab-3', registerTab: registerTabMockFn })
        ));
        var item1 = component.find('Tab[name="tab-1"]').find('a');
        var item2 = component.find('Tab[name="tab-2"]').find('a');
        var item3 = component.find('Tab[name="tab-3"]').find('a');
    ...
    it('should call updateButtonsVisibility function and set isFirstTime to false when all children are registered and is first time', function () {
        ...
        component.setState({
            tabsetChildren: [_react2.default.createElement(_Tab2.default, { label: 'Tab-1', name: 'tab-1', registerTab: registerTabMockFn }), _react2.default.createElement(_Tab2.default, { label: 'Tab-2', name: 'tab-2', registerTab: registerTabMockFn }), _react2.default.createElement(_Tab2.default, { label: 'Tab-3', name: 'tab-3', registerTab: registerTabMockFn })]
        });
        expect(component.instance().updateButtonsVisibility).toHaveBeenCalledTimes(1);
    ...
    it('should set the left button disabled to true', function () {
        ...
        var leftButton = component.find('button').at(0);
    ...
    it('should set the right button disabled to true', function () {
        ...
        component.setState({ areButtonsVisible: true });
        var leftButton = component.find('button').at(1);
        expect(leftButton.prop('disabled')).toBe(true);
    });
    ...
    it('should set the right scroll motion when click on the first tab', function () {
        ...
        var component = (0, _enzyme.mount)(_react2.default.createElement(
            _index2.default,
            { onSelect: onSelectMockFn, activeTabName: 'tab-1' },
            _react2.default.createElement(_Tab2.default, { label: 'Tab-1', name: 'tab-1', registerTab: registerTabMockFn }),
            _react2.default.createElement(_Tab2.default, { label: 'Tab-2', name: 'tab-2', registerTab: registerTabMockFn }),
            _react2.default.createElement(_Tab2.default, { label: 'Tab-3', name: 'tab-3', registerTab: registerTabMockFn })
        ));
