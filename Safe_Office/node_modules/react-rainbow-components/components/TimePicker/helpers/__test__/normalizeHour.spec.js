...
var _normalizeHour = require('../normalizeHour');
...
describe('normalizeHour', function () {
    it('should return an empty string when the value passed is other type than a number', function () {
        ...
        values.forEach(function (value) {
            return expect((0, _normalizeHour2.default)(value)).toBe('');
        });
    });
    it('should return "12" when the value passed is "000"', function () {
        expect((0, _normalizeHour2.default)('000')).toBe('12');
    });
    it('should return "00"', function () {
        var values = ['0', '00', '0000'];
        values.forEach(function (value) {
            return expect((0, _normalizeHour2.default)(value)).toBe('00');
        });
    });
    it('should prefix with 0 when the value is less than 10', function () {
        ...
        values.forEach(function (value, index) {
            return expect((0, _normalizeHour2.default)(value)).toBe(expects[index]);
        });
    });
    ...
    it('should return "11"', function () {
        expect((0, _normalizeHour2.default)('011')).toBe('11');
    });
});