...
var icon = _react2.default.createElement('svg', null);
...
describe('<Input/>', function () {
    ...
    it('should set the type passed in the input element', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { type: 'color' }));
    ...
    it('should set the placeholder passed in the input element', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { placeholder: 'Placeholder Text' }));
    ...
    it('should have the right class names when icon is passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { icon: icon }));
    ...
    it('should have the right class names when icon is passed and iconPosition is right', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { icon: icon, iconPosition: 'right' }));
    ...
    it('should have the right class names when isBare', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { isBare: true }));
        expect(component.find('input').prop('className')).toBe('rainbow-time-picker_input rainbow-time-picker_input--bare');
    });
    it('should have the right class names when isCentered', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_2.default, { isCentered: true }));
