...
var resizeBarSelector = '.rainbow-table_header-resize-bar';
...
describe('<ResizeBar />', function () {
    it('should set isResizable passed to isTrue in RenderIf component', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_resizeBar2.default, { isResizable: true }));
        expect(component.find('RenderIf').prop('isTrue')).toBe(true);
    });
    it('should pass the right props to input element', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_resizeBar2.default, {
            isResizable: true,
    ...
    it('should handle onMouseDown event', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_resizeBar2.default, { isResizable: true, headerWidth: 350 }));
    ...
    it('should handle onMouseMove event', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_resizeBar2.default, { isResizable: true, headerWidth: 200, minColumnWidth: 50, maxColumnWidth: 1000 }));
        var resizeBar = component.find(resizeBarSelector);
        resizeBar.simulate('mousedown', { clientX: 120 });
        eventMap.mousemove({ clientX: 200, preventDefault: preventDefault });
    ...
    it('should handle onMouseMove event and set newXposition to 800 if the new width is bigger than 1000', function () {
        ...
        eventMap.mousemove({ clientX: 2000, preventDefault: preventDefault });
    ...
    it('should set the right state when handle onMouseMove event', function () {
        ...
        resizeBar.simulate('mousedown', { clientX: 100 });
        eventMap.mousemove({ clientX: 150, preventDefault: preventDefault });
