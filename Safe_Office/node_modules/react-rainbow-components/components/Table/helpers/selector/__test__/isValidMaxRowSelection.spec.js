...
var _isValidMaxRowSelection = require('../isValidMaxRowSelection');

var _isValidMaxRowSelection2 = _interopRequireDefault(_isValidMaxRowSelection);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

describe('isValidMaxRowSelection', function () {
    it('should return false when any arguments are passed', function () {
        expect((0, _isValidMaxRowSelection2.default)()).toBe(false);
    });
    it('should return true when maxRowSelection and rowsLength are the same', function () {
        var values = [0, 1, 2];
        values.forEach(function (value) {
            expect((0, _isValidMaxRowSelection2.default)(value, value)).toBe(true);
        });
    });
    it('should return true when maxRowSelection is less than rowsLength', function () {
        ...
        values.forEach(function (value) {
            ...
            expect((0, _isValidMaxRowSelection2.default)(maxRowSelection, rowsLength)).toBe(true);
        });
    });
    it('should return false when maxRowSelection is greater than rowsLength', function () {
        ...
        values.forEach(function (value) {
            ...
            var rowsLength = 2;
            expect((0, _isValidMaxRowSelection2.default)(maxRowSelection, rowsLength)).toBe(false);
        });
    });
