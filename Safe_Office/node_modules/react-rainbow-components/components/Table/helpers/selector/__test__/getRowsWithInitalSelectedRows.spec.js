...
var _getRowsWithInitalSelectedRows = require('../getRowsWithInitalSelectedRows');

var _getRowsWithInitalSelectedRows2 = _interopRequireDefault(_getRowsWithInitalSelectedRows);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var rows = [{ key: 'row-1' }, { key: 'row-2' }, { key: 'row-3' }]; /* eslint-disable no-console */
...
describe('getRowsWithInitalSelectedRows', function () {
    it('should return an empty array when any params are passed', function () {
        expect((0, _getRowsWithInitalSelectedRows2.default)()).toEqual([]);
    });
    it('should return the same rows passed when selectedRows passed is not an array', function () {
        ...
        values.forEach(function (value) {
            expect((0, _getRowsWithInitalSelectedRows2.default)({
                rows: rows,
                selectedRows: value,
                maxRowSelection: 3,
                indexes: indexes,
    ...
    it('should return the right rows when there are not selectedRows', function () {
        ...
        expect((0, _getRowsWithInitalSelectedRows2.default)({
            ...
            indexes: indexes,
            selectedRowsKeys: selectedRowsKeys
        })).toEqual([{ key: 'row-1', isSelected: false }, { key: 'row-2', isSelected: false }, { key: 'row-3', isSelected: false }]);
        expect(selectedRowsKeys).toEqual({});
    });
    it('should return the right rows when maxRowSelection is 1 and there is only one row selected', function () {
        ...
        expect((0, _getRowsWithInitalSelectedRows2.default)({
            ...
            indexes: indexes,
            selectedRowsKeys: selectedRowsKeys
        })).toEqual([{ key: 'row-1', isSelected: false }, { key: 'row-2', isSelected: true }, { key: 'row-3', isSelected: false }]);
        expect(selectedRowsKeys).toEqual({
            'row-2': true
        });
    });
    it('should return the right rows when maxRowSelection is 1 and there is two rows selected', function () {
        ...
        expect((0, _getRowsWithInitalSelectedRows2.default)({
            ...
            indexes: indexes,
            selectedRowsKeys: selectedRowsKeys
        })).toEqual([{ key: 'row-1', isSelected: false }, { key: 'row-2', isSelected: false }, { key: 'row-3', isSelected: true }]);
        expect(selectedRowsKeys).toEqual({
            'row-3': true
        });
    });
    it('should return the right rows when maxRowSelection is greater than 1 and match with the length of rows selected', function () {
        ...
        expect((0, _getRowsWithInitalSelectedRows2.default)({
            ...
            indexes: indexes,
            selectedRowsKeys: selectedRowsKeys
        })).toEqual([{ key: 'row-1', isSelected: true }, { key: 'row-2', isSelected: true }, { key: 'row-3', isDisabled: true }]);
        expect(selectedRowsKeys).toEqual({
            'row-1': true,
            'row-2': true
        });
    ...
    it('should return the right rows when maxRowSelection is equal to previous selection lenght and greater than the length of rows selected', function () {
        ...
        expect((0, _getRowsWithInitalSelectedRows2.default)({
            ...
            indexes: indexes,
            selectedRowsKeys: selectedRowsKeys
        })).toEqual([{ key: 'row-1', isDisabled: false }, { key: 'row-2', isDisabled: false }, { key: 'row-3', isDisabled: false }]);
        expect(selectedRowsKeys).toEqual({
            'row-1': true,
            'row-2': true,
            'row-3': true
