...
var _getBulkSelectionState = require('../getBulkSelectionState');

var _getBulkSelectionState2 = _interopRequireDefault(_getBulkSelectionState);
...
describe('getBulkSelectionState', function () {
    it('should return "none" when any params are passed', function () {
        expect((0, _getBulkSelectionState2.default)()).toBe('none');
    });
    it('should return "none" when selectedRowsKeys length is 0', function () {
        expect((0, _getBulkSelectionState2.default)({
            maxRowSelection: 3,
            selectedRowsKeys: {}
        })).toBe('none');
    });
