...
var _getUpdatedColumns = require('../getUpdatedColumns');

var _getUpdatedColumns2 = _interopRequireDefault(_getUpdatedColumns);
...
describe('resizer helper', function () {
    describe('getUpdatedColumns', function () {
        it('should return an empty array', function () {
            ...
            expect((0, _getUpdatedColumns2.default)(params)).toEqual([]);
        });
        ...
        it('should return the right columns when already have metadata', function () {
            var params = {
                columns: [{ label: 'Name', field: 'name', computedWidth: 35, isResized: true }, {
                    label: 'Email',
                    field: 'email',
                    computedWidth: 123,
                    isResized: false
