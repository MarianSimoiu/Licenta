...
describe('<Row />', function () {
    it('should return a tr element with no children when columns is not passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_row2.default, { rowData: data, columns: undefined }));
    ...
    it('should return the amount of Cell components that correspond with the columns', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_row2.default, { rowData: data, columns: columns }));
    ...
    it('should set empty string to value prop in Cell component when the column field does not exists', function () {
        ...
        values.forEach(function (value) {
            var component = (0, _enzyme.mount)(_react2.default.createElement(_row2.default, { rowData: data, columns: value }));
            var cell = component.find('Cell');
    ...
    it('should set the right value prop in Cell component when use dot notation in field', function () {
        ...
        var component = (0, _enzyme.mount)(_react2.default.createElement(_row2.default, { rowData: rowData, columns: rowColumns }));
        var cell = component.find('Cell');
        expect(cell.at(0).prop('value')).toBe('a');
        expect(cell.at(1).prop('value')).toBe(0);
    });
    it('should set the right class names in tr element when the row is selected', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_row2.default, { rowData: data, columns: columns, isSelected: true }));
    ...
    it('should set the right value to isFirst prop in Cell component when the firs column is selectable checkbox', function () {
        ...
        var component = (0, _enzyme.mount)(_react2.default.createElement(_row2.default, { rowData: data, columns: columnsWithSelectable }));
        var cell = component.find('Cell');
    ...
    it('should render LoadingCells component when data type is LOADING', function () {
        var rowData = { type: 'LOADING' };
        var component = (0, _enzyme.mount)(_react2.default.createElement(_row2.default, { rowData: rowData, columns: columns }));
