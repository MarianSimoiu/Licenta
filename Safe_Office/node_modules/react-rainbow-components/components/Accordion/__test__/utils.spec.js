...
describe('<Accordion/> utils', function () {
    ...
    describe('getChildAccordionSectionNodes', function () {
        var elements = [{ element: 'a', innerText: 'lettuce' }, { element: 'a', innerText: 'tomato' }];
        var ref = {
            querySelectorAll: jest.fn(function () {
                return elements;
            })
        };
        it('should call querySelectorAll with "div.rainbow-accordion-section_summary:nth-child(2)"', function () {
