...
describe('<Button/>', function () {
    it('should focus the button when the focus method is called', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'OK' }));
    ...
    it('should set disable to true when it is passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'my label', disabled: true }));

        expect(component.find('button').prop('disabled')).toBe(true);
    });
    it('should set the tabIndex passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'my label', tabIndex: 0 }));

        expect(component.find('button').prop('tabIndex')).toBe(0);
    });
    it('should set the title passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'my label', title: 'my title' }));

        expect(component.find('button').prop('title')).toBe('my title');
    });
    it('should set the type passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'my label', type: 'reset' }));

        expect(component.find('button').prop('type')).toBe('reset');
    });
    it('should set aria-haspopup to true when it is passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'my label', ariaHaspopup: true }));

        expect(component.find('button').prop('aria-haspopup')).toBe(true);
    });
    it('should set the label passed as children', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'Click me' }));

        expect(component.find('button').text()).toBe('Click me');
    });
    it('should have the right class names', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'Button Label' }));
    ...
    it('should have the right class names when variant base and have a custom class', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'Button Label', variant: 'base', className: 'my-custom-class-name' }));
    ...
    it('should have the right class names when variant brand', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'Button Label', variant: 'brand' }));
    ...
    it('should have the right class names when variant outline-brand', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'Button Label', variant: 'outline-brand' }));
    ...
    it('should have the right class names when variant destructive', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'Button Label', variant: 'destructive' }));
    ...
    it('should have the right class names when variant success', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'Button Label', variant: 'success' }));
    ...
    it('should have the right class names when variant inverse', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'Button Label', variant: 'inverse' }));
    ...
    it('should have the right class names when shaded is true and the valid shaded variants are passed', function () {
        ...
        variants.forEach(function (variant) {
            var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'Button Label', variant: variant, shaded: true }));
    ...
    it('should have the right class names when shaded is true and variant is base', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'Button Label', variant: 'base', shaded: true }));
        var buttonClassNameProp = component.find('button').prop('className');
        expect(buttonClassNameProp).toBe('rainbow-button');
    });
    it('should render the Spinner when isLoading is passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'Button Label', isLoading: true }));
        expect(component.find(_Spinner2.default).exists()).toBe(true);
    });
    it('should set disable to true when isLoading is passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'my label', isLoading: true }));
    ...
    it('should have the right class names when isLoading is true', function () {
        ...
        variants.forEach(function (variant) {
            var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'Button Label', variant: variant, isLoading: true }));
            var buttonClassNameProp = component.find('button').prop('className');
    ...
    it('should have the right class names when isLoading is true and variant is base', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'Button Label', variant: 'base', isLoading: true }));
        var buttonClassNameProp = component.find('button').prop('className');
        expect(buttonClassNameProp).toBe('rainbow-button');
    });
    it('should render the Spinner and label when isLoading and label are passed', function () {
        var component = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, { label: 'OK', isLoading: true }));
