...
function BookForColleague({history, match}) {
  ...
  <>
    {userInfo &&
      ...
      <TextBar text={"Book a desk for your colleague!"}></TextBar>
      ...
      <form onSubmit={SubmitHandler} id="first-form">
          ...
          <div className="row">
              <div className="col-sm-4">
                ...
                <div className="control-point" id="cp-name">
                  <label for="nameSelect">Colleague:</label> 
                  <input type="text" className="form-control" id="nameSelect"></input>
                </div>
